    ...
    if (currentPath.startsWith("/signup")) {
        ...
        const handleSubmit = async (e) => {
            ...
            if (canSignUp) {
                ...
                if (!validFirstName) {
                    setFirstNameClass(
                        "mb-none outline outline-2 outline-red-500"
                    );
                ...
                if (!validPassword) {
                    ...
                    setConfirmPasswordClass(
                        "mb-8 outline outline-2 outline-red-500"
                    );
        ...
        return (
            <div className="bg-purple-700 container mx-auto text-center flex flex-col justify-center h-screen">
                <h1 className="text-white text-4xl pb-10 font-bold mx-auto">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    />
                    <p
                        className="text-red-500 mb-2 text-s"
                        ref={firstNameErrMsg}
                    />
                    <AuthInput
                        id="lastName"
        ...
        return (
            <div className="bg-purple-700 container mx-auto text-center text-white flex flex-col justify-center h-screen">
                ...
                <p className="border-5 font-bold text-xl mb-10">
                    Sign up to learn about the best projects!
                </p>
                <AuthButton
                    buttonText={"Sign Up"}
